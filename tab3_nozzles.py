...
def _build_ga_drawing(c, t2, nozzles_df):
    ...
    # 4. BOTTOM SLOPE SYMBOL (1% SLOPE DOWN TO LEFT)
    ...
    # 6. TOTAL HEIGHT DIMENSION LINE (EXTREMELY PUSHED TO AVOID ANY CLASH)
    ...
    for i, row in enumerate(left_n):
        ...
        elif "DRAIN" in str(row['Service']).upper(): y = H * 0.08 # <--- CLEARLY SHIFTED UP FROM THE BOTTOM
...
def render(c, t2):
    ...
    # tab3_nozzles.py ke end mein add karein
    return {
